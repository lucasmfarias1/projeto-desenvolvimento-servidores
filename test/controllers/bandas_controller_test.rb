...
class BandasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banda" do
    assert_difference('Banda.count') do
      post bandas_url, params: { banda: { ano: @banda.ano, genero: @banda.genero, nome: @banda.nome, pais: @banda.pais } }
    end
  ...
  test "should update banda" do
    patch banda_url(@banda), params: { banda: { ano: @banda.ano, genero: @banda.genero, nome: @banda.nome, pais: @banda.pais } }
